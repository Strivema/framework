...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="index.html">
                <img src="${ossPath}layouts/layout2/img/logo-default.png" alt="logo" class="logo-default"/> </a>
...
<div class="page-container">
    ...
    <div class="page-sidebar-wrapper">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu" id="navTab"
...
<script type="text/javascript">
    ...
    Layout.addAjaxContentSuccessCallback(function () {
        // 页面加载成功，调用改此处
    });
    intPage();
    ...
    function getMenu(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            if (menu.leaf) {
                // 如果是子节点
                result += '<li class="nav-item"><a href="' + menu.href + '" class="ajaxify nav-link">' +
                        '<i class="' + menu.icon + '"></i><span class="title">' + menu.name + '</span>' +
                        '</a></li>';
            } else {
