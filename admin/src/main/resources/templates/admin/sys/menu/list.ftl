                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="btn-group">
                                    <button class="btn  green btn-add" data-url="admin/sys/menu/save.html"
...
<script type="text/javascript">
    ...
    function initTreeGrid() {
        var beeTable = $('#bee_table');
        $.get('sys/menu/treeGrid', params, function (result) {
            beeTable.find("tbody").html("");
            $.each(result, function (i, menu) {
                beeTable.find("tbody").append(initTr(menu));
            });
            beeTable.treegrid({
                treeColumn: 1,
            ...
            beeTable.find('.group-checkable').change(function () {
    ...
    function initTr(menu, parentId) {
        if (typeof menu.href === 'undefined') {
            menu.href = "";
        }
        if (typeof menu.permission === 'undefined') {
            menu.permission = "";
        }
        var show;
        if (menu.show) {
